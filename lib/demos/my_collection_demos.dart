...
class CollectionItems {
  ...
  CollectionItems() {
    items = [
      CollectionModel(imagePath: ProjectImages.imagePath, title: 'Abstract Art', price: 3.14),
      CollectionModel(imagePath: ProjectImages.imagePath, title: 'Abstract Art2', price: 3.14),
      CollectionModel(imagePath: ProjectImages.imagePath, title: 'Abstract Art3', price: 3.14),
      CollectionModel(imagePath: ProjectImages.imagePath, title: 'Abstract Art4', price: 3.14),
    ];
  }
}

class ProjectImages {
  static const imagePath = 'assets/png/image_collection.png';
}
